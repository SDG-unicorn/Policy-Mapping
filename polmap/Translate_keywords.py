...
parser.add_argument('-ex', '--expand_keywords', help='Expand keywords to multiple columns', type=bool, default=False)
#parser.add_argument('-tr', '--translate_keywords', help='Translate keywords to a different language', type=bool, default=False)
